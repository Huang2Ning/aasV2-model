...
public abstract class MultiLanguagePropertyBuilder<T extends MultiLanguageProperty, B extends MultiLanguagePropertyBuilder<T, B>> extends ExtendableBuilder<T, B> {
