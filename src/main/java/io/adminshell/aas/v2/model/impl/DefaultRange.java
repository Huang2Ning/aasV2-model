...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.Range
...
@IRI("http://admin-shell.io/aas/2/0#Range")
public class DefaultRange implements Range {
	...
	protected List<String> maxs = new ArrayList<>();


	
	@IRI("http://admin-shell.io/aas/2/0#min")
	protected List<String> mins = new ArrayList<>();
