...
public abstract class SecurityBuilder<T extends Security, B extends SecurityBuilder<T, B>> extends ExtendableBuilder<T, B> {
	...
	*/
	public B accessControlPolicyPoints(List<PolicyAdministrationPoint> accessControlPolicyPoints) {
		getBuildingInstance().setAccessControlPolicyPoints(accessControlPolicyPoints);
		return getSelf();
	}

	/**
	* This function allows adding a value to the List accessControlPolicyPoints
	* @param accessControlPolicyPoints desired value to be added
	* @return Builder object with new value for accessControlPolicyPoints
	*/
	public B accessControlPolicyPoints(PolicyAdministrationPoint accessControlPolicyPoints) {
		getBuildingInstance().getAccessControlPolicyPoints().add(accessControlPolicyPoints);
		return getSelf();
	}
