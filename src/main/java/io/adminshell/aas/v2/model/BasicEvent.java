...
public interface BasicEvent {
	...
	*
	* More information under http://admin-shell.io/aas/2/0#observed
	*
	* @return Returns the List of References for the property observeds.
	*/
	@IRI("http://admin-shell.io/aas/2/0#observed")
	List<Reference> getObserveds();
	...
	* More information under http://admin-shell.io/aas/2/0#observed
	*
	* @param observeds desired value for the property observeds.
	*/
	 void setObserveds (List<Reference> observeds);
