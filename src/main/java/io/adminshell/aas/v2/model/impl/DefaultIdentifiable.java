...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.Identifiable
	
* An element that has a globally unique identifier. 
*/

@IRI("http://admin-shell.io/aas/2/0#Identifiable")
public class DefaultIdentifiable implements Identifiable {
	...
	protected Identifier identifications;
	...
	@Override 
	 public void setIdentification(Identifier identifications) {
