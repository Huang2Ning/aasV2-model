...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.PolicyAdministrationPoint
...
public class DefaultPolicyAdministrationPoint<T, Endpoint> implements PolicyAdministrationPoint {

	
	@IRI("http://admin-shell.io/aas/2/0#externalAccessControl")
	protected List<T> externalAccessControls = new ArrayList<>();


	
	@IRI("http://admin-shell.io/aas/2/0#localAccessControl")
	protected List<AccessControl> localAccessControls = new ArrayList<>();
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.localAccessControls,
	...
	@Override 
	public List<Endpoint> getExternalAccessControls() {
		return externalAccessControls;
	}
	
	@Override 
	 public void setExternalAccessControls (List<Endpoint> externalAccessControls) {
