...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.BasicEvent
	
*  
*/

@IRI("http://admin-shell.io/aas/2/0#BasicEvent")
public class DefaultBasicEvent implements BasicEvent {
	...
	@IRI("http://admin-shell.io/aas/2/0#observed")
	protected List<Reference> observeds = new ArrayList<>();
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.observeds,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.observeds, other.observeds) &&
	...
	@Override 
	public List<Reference> getObserveds() {
		return observeds;
	}
	
	@Override 
	 public void setObserveds (List<Reference> observeds) {
