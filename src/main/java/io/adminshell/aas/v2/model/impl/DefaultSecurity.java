...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.Security
	
* Container for security relevant information of the AAS. 
*/

@IRI("http://admin-shell.io/aas/2/0#Security")
public class DefaultSecurity implements Security {

	
	@IRI("http://admin-shell.io/aas/2/0#accessControlPolicyPoints")
	protected List<PolicyAdministrationPoint> accessControlPolicyPoints = new ArrayList<>();
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.certificates, other.certificates) &&
				Objects.equals(this.accessControlPolicyPoints, other.accessControlPolicyPoints) &&
	...
	@Override 
	public List<PolicyAdministrationPoint> getAccessControlPolicyPoints() {
		return accessControlPolicyPoints;
	}
	
	@Override 
	 public void setAccessControlPolicyPoints (List<PolicyAdministrationPoint> accessControlPolicyPoints) {
