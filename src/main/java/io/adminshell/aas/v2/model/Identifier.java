...
public interface Identifier {
	...
	*
	* More information under http://admin-shell.io/aas/2/0#idType
	*
	* @return Returns the List of IdentifierTypes for the property idTypes.
	*/
	@IRI("http://admin-shell.io/aas/2/0#idType")
	...
	*
	* More information under http://admin-shell.io/aas/2/0#id
	*
	* @return Returns the List of Strings for the property ids.
	*/
	@IRI("http://admin-shell.io/aas/2/0#id")
	List<String> getIds();
	...
	* More information under http://admin-shell.io/aas/2/0#id
	*
	* @param ids desired value for the property ids.
	*/
