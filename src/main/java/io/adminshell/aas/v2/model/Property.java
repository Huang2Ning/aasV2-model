...
public interface Property {
	...
	*
	* More information under http://admin-shell.io/aas/2/0#propertyValueId
	*
	* @return Returns the List of References for the property propertyValueIds.
	*/
	@IRI("http://admin-shell.io/aas/2/0#propertyValueId")
	List<Reference> getPropertyValueIds();
	...
	* More information under http://admin-shell.io/aas/2/0#propertyValueId
	*
	* @param propertyValueIds desired value for the property propertyValueIds.
	*/
	 void setPropertyValueIds (List<Reference> propertyValueIds);
