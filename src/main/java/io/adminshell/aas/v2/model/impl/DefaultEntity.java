...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.Entity
	
* An entity is a submodel element that is used to model entities. 
*/

@IRI("http://admin-shell.io/aas/2/0#Entity")
public class DefaultEntity implements Entity {
	...
	protected List<EntityType> entityTypes = new ArrayList<>();
