...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.Permission
...
public class DefaultPermission implements Permission {
	...
	protected List<PermissionKind> kindOfPermissions = new ArrayList<>();


	
	@IRI("http://admin-shell.io/aas/2/0#permission")
	protected List<Property> permissions = new ArrayList<>();
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.permissions, other.permissions) &&
				Objects.equals(this.kindOfPermissions, other.kindOfPermissions);
		}
	}
