...
public interface Range {
	...
	*
	* Constraint AASd-012-3: In case of a range with kind=Instance either the min or the max value or both need to be defined.
	*
	* More information under http://admin-shell.io/aas/2/0#max
	*
	* @return Returns the List of Strings for the property maxs.
	*/
	@IRI("http://admin-shell.io/aas/2/0#max")
	List<String> getMaxs();
	...
	* More information under http://admin-shell.io/aas/2/0#max
	*
	* @param maxs desired value for the property maxs.
	*/
	 void setMaxs (List<String> maxs);
	...
	* Constraint AASd-012-3: In case of a range with kind=Instance either the min or the max value or both need to be defined.
	*
	* More information under http://admin-shell.io/aas/2/0#min
	*
	* @return Returns the List of Strings for the property mins.
	*/
	@IRI("http://admin-shell.io/aas/2/0#min")
	List<String> getMins();
	...
	* More information under http://admin-shell.io/aas/2/0#min
	*
	* @param mins desired value for the property mins.
	*/
	 void setMins (List<String> mins);
