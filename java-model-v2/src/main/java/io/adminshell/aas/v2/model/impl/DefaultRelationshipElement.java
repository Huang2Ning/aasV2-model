...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.RelationshipElement
	 
*/

@IRI("http://admin-shell.io/aas/2/0#RelationshipElement")
public class DefaultRelationshipElement implements RelationshipElement {
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.relationshipFirsts,
