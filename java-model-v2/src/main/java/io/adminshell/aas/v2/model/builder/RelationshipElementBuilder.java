...
public abstract class RelationshipElementBuilder<T extends RelationshipElement, B extends RelationshipElementBuilder<T, B>> extends ExtendableBuilder<T, B> {
	...
	/**
	* This function allows setting a value for relationshipFirsts
	* @param relationshipFirsts desired value to be set
	* @return Builder object with new value for relationshipFirsts
	*/
	public B relationshipFirsts(List<Referable> relationshipFirsts) {
		getBuildingInstance().setRelationshipFirsts(relationshipFirsts);
		return getSelf();
	}

	/**
	* This function allows adding a value to the List relationshipFirsts
	* @param relationshipFirst desired value to be added
	* @return Builder object with new value for relationshipFirsts
	*/
	public B relationshipFirst(Referable relationshipFirst) {
		getBuildingInstance().getRelationshipFirsts().add(relationshipFirst);
		return getSelf();
	}


	/**
	* This function allows setting a value for relationshipSeconds
	* @param relationshipSeconds desired value to be set
	* @return Builder object with new value for relationshipSeconds
	*/
	public B relationshipSeconds(List<Referable> relationshipSeconds) {
		getBuildingInstance().setRelationshipSeconds(relationshipSeconds);
		return getSelf();
	}

	/**
	* This function allows adding a value to the List relationshipSeconds
	* @param relationshipSecond desired value to be added
	* @return Builder object with new value for relationshipSeconds
	*/
	public B relationshipSecond(Referable relationshipSecond) {
		getBuildingInstance().getRelationshipSeconds().add(relationshipSecond);
		return getSelf();
	}
