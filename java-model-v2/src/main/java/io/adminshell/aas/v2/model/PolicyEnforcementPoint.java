...
*/
@KnownSubtypes({
	@KnownSubtypes.Type(value = DefaultPolicyEnforcementPoint.class)
})
public interface PolicyEnforcementPoint {
	...
	*
	* More information under http://admin-shell.io/aas/2/0#externalPolicyDecisionPoint
	*
	* @return Returns the List of Booleans for the property externalPolicyDecisionPoints.
	*/
	@IRI("http://admin-shell.io/aas/2/0#externalPolicyDecisionPoint")
	List<Boolean> getExternalPolicyDecisionPoints();
	...
	*/
	 void setExternalPolicyDecisionPoints (List<Boolean> externalPolicyDecisionPoints);
	...
	*
	* More information under http://admin-shell.io/aas/2/0#externalPolicyEnforcementPoint
	*
	* @return Returns the List of Booleans for the property externalPolicyEnforcementPoints.
	*/
	@IRI("http://admin-shell.io/aas/2/0#externalPolicyEnforcementPoint")
	List<Boolean> getExternalPolicyEnforcementPoints();
	...
	* More information under http://admin-shell.io/aas/2/0#externalPolicyEnforcementPoint
	*
	* @param externalPolicyEnforcementPoints desired value for the property externalPolicyEnforcementPoints.
	*/
	 void setExternalPolicyEnforcementPoints (List<Boolean> externalPolicyEnforcementPoints);
