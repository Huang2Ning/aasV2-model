...
public interface RelationshipElement {
	...
	*
	* More information under http://admin-shell.io/aas/2/0#relationshipFirst
	*
	* @return Returns the List of Referables for the property relationshipFirsts.
	*/
	@IRI("http://admin-shell.io/aas/2/0#relationshipFirst")
	List<Referable> getRelationshipFirsts();
	...
	* More information under http://admin-shell.io/aas/2/0#relationshipFirst
	*
	* @param relationshipFirsts desired value for the property relationshipFirsts.
	*/
	 void setRelationshipFirsts (List<Referable> relationshipFirsts);

	/**
	* Second element in the relationship taking the role of the object.
	*
	* More information under http://admin-shell.io/aas/2/0#relationshipSecond
	*
	* @return Returns the List of Referables for the property relationshipSeconds.
	*/
	@IRI("http://admin-shell.io/aas/2/0#relationshipSecond")
	List<Referable> getRelationshipSeconds();
	...
	* More information under http://admin-shell.io/aas/2/0#relationshipSecond
	*
	* @param relationshipSeconds desired value for the property relationshipSeconds.
	*/
	 void setRelationshipSeconds (List<Referable> relationshipSeconds);
