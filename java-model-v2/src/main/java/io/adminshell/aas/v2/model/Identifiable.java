...
@KnownSubtypes({
	...
	@KnownSubtypes.Type(value = DataSpecification.class),
...
public interface Identifiable {
	...
	*
	* More information under http://admin-shell.io/aas/2/0#administration
	*
	...
	*
	* More information under http://admin-shell.io/aas/2/0#identification
	*
	*/
