...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.Property
	
* A property is a data element that has a single value. 
*/

@IRI("http://admin-shell.io/aas/2/0#Property")
public class DefaultProperty implements Property {
	...
	@IRI("http://admin-shell.io/aas/2/0#propertyValueId")
	protected List<Reference> propertyValueIds = new ArrayList<>();
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.propertyValueIds,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			return Objects.equals(this.propertyValueIds, other.propertyValueIds) &&
	...
	@Override 
	public List<Reference> getPropertyValueIds() {
		return propertyValueIds;
	}
	
	@Override 
	 public void setPropertyValueIds (List<Reference> propertyValueIds) {
