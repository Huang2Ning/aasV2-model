...
public abstract class IdentifierBuilder<T extends Identifier, B extends IdentifierBuilder<T, B>> extends ExtendableBuilder<T, B> {
	...
	*/
	...
	/**
	* This function allows setting a value for ids
	* @param ids desired value to be set
	* @return Builder object with new value for ids
	*/
	public B ids(List<String> ids) {
		getBuildingInstance().setIds(ids);
		return getSelf();
	}

	/**
	* This function allows adding a value to the List ids
	* @param id desired value to be added
	* @return Builder object with new value for ids
	*/
	public B id(String id) {
		getBuildingInstance().getIds().add(id);
		return getSelf();
	}
}
