...
public abstract class AccessPermissionRuleBuilder<T extends AccessPermissionRule, B extends AccessPermissionRuleBuilder<T, B>> extends ExtendableBuilder<T, B> {
	...
	*/
	public B targetSubjectAttributes(List<SubjectAttributes> targetSubjectAttributes) {
		getBuildingInstance().setTargetSubjectAttributes(targetSubjectAttributes);
		return getSelf();
	}

	/**
	* This function allows adding a value to the List targetSubjectAttributes
	* @param targetSubjectAttributes desired value to be added
	* @return Builder object with new value for targetSubjectAttributes
	*/
	public B targetSubjectAttributes(SubjectAttributes targetSubjectAttributes) {
		getBuildingInstance().getTargetSubjectAttributes().add(targetSubjectAttributes);
		return getSelf();
	}
	...
	*/
	public B parents(List<Referable> parents) {
		((Referable) getBuildingInstance()).setParents(parents);
		return getSelf();
	}
	...
	*/
	public B parent(Referable parent) {
		((Referable) getBuildingInstance()).getParents().add(parent);
		return getSelf();
	}
...
//		((Referable) getBuildingInstance()).setCategories(categories);
//		return getSelf();
//	}
//
//	/**
...
//		((Referable) getBuildingInstance()).getCategories().add(category);
//		return getSelf();
//	}
//
//
...
//		((Referable) getBuildingInstance()).setDescriptions(descriptions);
//		return getSelf();
//	}
//
//	/**
...
//		((Referable) getBuildingInstance()).getDescriptions().add(description);
//		return getSelf();
//	}
//
//
...
//		((Referable) getBuildingInstance()).setIdShorts(idShorts);
//		return getSelf();
//	}
//
//	/**
...
//		((Referable) getBuildingInstance()).getIdShorts().add(idShort);
//		return getSelf();
//	}
//
//
...
//		((Object) getBuildingInstance()).setQualifiers(qualifiers);
//		return getSelf();
//	}
//
//	/**
