...
/** 
	* Default implementation of package io.adminshell.aas.v2.model.SubjectAttributes
	
* A set of data elements that further classifies a specific subject. 
*/

@IRI("http://admin-shell.io/aas/2/0#SubjectAttributes")
public class DefaultSubjectAttributes implements SubjectAttributes {

	
	@IRI("http://admin-shell.io/aas/2/0#subjectAttribute")
