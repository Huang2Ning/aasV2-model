...
public abstract class PolicyInformationPointsBuilder<T extends PolicyInformationPoints, B extends PolicyInformationPointsBuilder<T, B>> extends ExtendableBuilder<T, B> {
	...
	*/
	public B externalInformationPoints(List<T> externalInformationPoints) {
		getBuildingInstance().setExternalInformationPoints(externalInformationPoints);
		return getSelf();
	}

	/**
	* This function allows adding a value to the List externalInformationPoints
	* @param externalInformationPoints desired value to be added
	* @return Builder object with new value for externalInformationPoints
	*/
	public B externalInformationPoints(T externalInformationPoints) {
		getBuildingInstance().getExternalInformationPoints().add(externalInformationPoints);
		return getSelf();
	}
