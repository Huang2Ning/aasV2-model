...
public enum EntityType {
	...
	/** 
	* For co-managed entities there is no separate AAS. Co-managed entities need to be part of a selfmanaged entity.
	*/
	@IRI("http://admin-shell.io/aas/2/0#CO_MANAGED_ENTITY")
CO_MANAGED_ENTITY,
	...
	*/
	@IRI("http://admin-shell.io/aas/2/0#SELF_MANAGED_ENTITY")
SELF_MANAGED_ENTITY;
